...
const Customer = ({ name, email, phone }) => {
  return (
    <div className="backdrop-blur-sm rounded-md  min-w-[220px] max-w-[420px] shadow-md overflow-hidden ">
      ...
      <div className="px-3 py-4 bg-white/10 backdrop-blur-sm overflow-hidden">
      ...
      <div className="flex border-[1px] border-slate-400 rounded-bl-md rounded-br-md">
        <button className="flex justify-center p-2 flex-1 items-center  ">
          <span>Email</span>
...
const Details = ({ title, value }) => {
  return (
    <div className="flex items-center mb-3">
      ...
      <p className="text-gray-600 font-bold overflow-hidden break-words">
        {value}
      </p>
    </div>
  );
